...
class Sidebar extends Component
{
    ...
    public function mount()
    {
        ...
        $this->thesis = Thesis::select('theses.id', 'wpjs_users.user_login', DB::raw('COUNT(discussions.id) as discussion_count'))
        ...
        ->leftJoin('wpjs_users', 'theses.student_id', '=', 'wpjs_users.id')
        ->groupBy('theses.id', 'wpjs_users.user_login')
        ->get();
    }

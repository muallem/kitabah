...
<ul class="navbar-nav ms-auto">
    ...
    <li class="nav-item">
        <a href="#" data-bs-toggle="modal" data-bs-target="#modalDiscussion" wire:click="$emit('showDiscussion', {{ $item->id }})" class="navbar_message text-decoration-none text-dark position-relative p-1">
            {{ $item->user_login }}

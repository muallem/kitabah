            ...
            <div class="tab-content mt-3">
                <div class="tab-pane fade active show" id="kuan-bab_1_pendahuluan" role="tabpanel">
                    <ul class="nav nav-tabs nav-tabs-new2" role="tablist">
                        ...
                        <li class="nav-item" role="presentation" onclick="setKodeMateri('kuan-bab_1_pendahuluan-batasan_penelitian')"><a class="nav-link" data-bs-toggle="tab" href="#kuan-bab_1_pendahuluan-batasan_penelitian" aria-selected="false" role="tab" tabindex="-1" >Batasan Penelitian</a></li>
                    </ul>
                    <div class="tab-content mt-3">
